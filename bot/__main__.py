...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("😎 Master", "https://t.me/FakeErrorX")
    buttons.buildbutton("🌐 Website", "https://errorx.me")
    buttons.buildbutton("🇧🇩 Channel", "https://t.me/ErrorX_BD")
...
help_string = '''
<b><a href='https://t.me/ErrorX_BD>ErrorX</a></b> - The Ultimate Telegram MIrror-Leech Bot to Upload Your File & Link in Google Drive & Telegram
