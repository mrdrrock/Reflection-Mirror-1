    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/FakeErrorX">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/FakeErrorX"><i class="fab fa-github"></i></a>
        <a href="https://t.me/FakeErrorX"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>ErrorX<a href='https://errorx.me'>BOT</a> By <a href='https://t.me/ErrorX_BD'>Working</a></h1>"
